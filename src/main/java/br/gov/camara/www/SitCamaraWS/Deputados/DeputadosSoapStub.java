		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObtainDeputiesResponseObtainDeputiesResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObtainDeputiesResponseObtainDeputiesResult.class);
				}
			}
