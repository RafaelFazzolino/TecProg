...
public class TesteEstatisticaControl {
	...
	public void testGerarEstatisticas() throws ClassNotFoundException,
		...
		estatisticaTeste2 = EstatisticaControl
				.gerarEstatisticas("abelardo lupion-dem/pr");
		estatisticaTeste3 = EstatisticaControl
				.gerarEstatisticas("ABELARDO LUPION-DEM/PR");
	...
	public void testGerarEstatisticasComDoisParametros()
		...
		estatisticaTeste2 = EstatisticaControl.gerarEstatisticas(
				"abelardo lupion-dem/pr", 4);
		estatisticaTeste3 = EstatisticaControl.gerarEstatisticas(
				"ABELARDO LUPION-DEM/PR", 5);

		assertTrue(estatisticaTeste2 != null);
		assertTrue(estatisticaTeste3 != null);
		assertTrue(estatisticaTeste2.getName().equalsIgnoreCase(
	...
	public void testPassarListaCerta() {
		...
		listaParaTeste = EstatisticaControl.passarListaCerta(0, 10,
				listaParaTeste);
		assertTrue(listaParaTeste.size() <= 10);

		listaParaTeste2 = EstatisticaControl.passarListaCerta(5, 9,
				listaParaTeste2);
	...
	public void testPassarListaCertaExcessao() {
		...
		listaParaTeste = EstatisticaControl.passarListaCerta(5, 9,
				listaParaTeste);
	}
	...
	public void testOrdenarLista() {
		...
		ArrayList<String> ordenado = EstatisticaControl
				.ordenarLista(listaParaTeste);

		for (int i = 0; i < listaParaTeste.size(); i++) {
			assertTrue(ordenado.get(i).equals(
					listaParaTeste.get(listaParaTeste.size() - 1 - i)));
		}
	}
}
